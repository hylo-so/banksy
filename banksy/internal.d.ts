...
export declare class Banksy {
  constructor()
  start(computeMaxUnits?: bigint | undefined | null, transactionAccountLockLimit?: bigint | undefined | null): Promise<ProgramTestContext>
  addProgram(name: string, programId: Uint8Array, programAuthority: Uint8Array): void
  addUpgradableProgram(name: string, programId: Uint8Array, programAuthority: Uint8Array, programData: Uint8Array, upgradeSlot: bigint): void
  addAccount(address: Uint8Array, account: Account): void
  addAccountWithLamports(address: Uint8Array, owner: Uint8Array, lamports: bigint): void
  airdrop(address: Uint8Array, lamports: bigint): void
  addTokenMint(address: Uint8Array, supply: bigint, decimals: number, mintAuthority?: Uint8Array | undefined | null, freezeAuthority?: Uint8Array | undefined | null): void
  addTokenAccount(address: Uint8Array, mint: Uint8Array, owner: Uint8Array, amount: bigint, delegatedAmount: bigint, delegate?: Uint8Array | undefined | null, isNative?: bigint | undefined | null, closeAuthority?: Uint8Array | undefined | null): void
}
