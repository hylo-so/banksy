...
export declare class Banksy {
    private inner;
    private static _singleton;
    constructor();
    start(computeUnitsMax?: bigint, transactionAccountLockLimit?: bigint): Promise<ProgramTestContext>;
    getSingleton(computeUnitsMax?: bigint, transactionAccountLockLimit?: bigint): Promise<ProgramTestContext>;
    addProgram(name: string, programId: PublicKey): void;
    addUpgradableProgram(name: string, programId: PublicKey, programAuthority: PublicKey, programData: PublicKey): void;
    addAccount(address: PublicKey, account: AccountInfoBytes): void;
    addAccountWithLamports(address: PublicKey, owner: PublicKey, lamports: bigint): void;
    airdrop(address: PublicKey, lamports: bigint): void;
    addTokenMint(address: PublicKey, supply: bigint, decimals: number, mintAuthority?: PublicKey, freezeAuthority?: PublicKey): void;
    addTokenAccount(address: PublicKey, mint: PublicKey, owner: PublicKey, amount: bigint, delegatedAmount: bigint, delegate?: PublicKey, isNative?: bigint, closeAuthority?: PublicKey): void;
}
/**
 * Start a bankrun!
 *
